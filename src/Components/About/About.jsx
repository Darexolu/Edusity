  ...
  return (
    <div className='about'>
      ...
      <p>Embark on a transformative educational journey with our university's comprehensive education programs. 
        Our cutting-edge curriculum is designed empower students with the knowledge, skills and experiences needed to excel
      ...
      <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs prepare 
        aspiring educators to make a meaningful impact in classrooms, schools, and cummunities.
      </p>
      <p>
       Whether u aspire to become a teacher, administrator, counselor, or educational leader, our diverse range of programs 
